...
public class Window_Graph : MonoBehaviour
{
    ...
    public void GraficosLineas(List<double> pago, List<double> llego, int color)
    {
        ...
        for (int i = 0; i < valueList.Count; i++)
        {
            ...
            valueList[i] = ((double)valueList[i] * altoContiener); //se transforma el porcentaje segun alto de container (240)
    ...
    public Vector2 circleSize = new Vector2(11f, 11f);
    ...
    public float yMaximum = 240f;
    public float xSize = 45f;
    ...
    { //crea la linea de conexion entre 2 puntos
        ...
        rectTransform.anchorMin = new Vector2(0, 0);
        rectTransform.anchorMax = new Vector2(0, 0);
        rectTransform.sizeDelta = new Vector2(distance, dotConectionSize);
